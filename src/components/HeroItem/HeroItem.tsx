...
export function HeroItem({
  ...
  return (
    <div class="hero-item" {...rest}>
      ...
      <script>CSS.paintWorklet.addModule('/assets/js/HeroItem.js');</script>
      <script>CSS.paintWorklet.addModule('/assets/js/bytemare.js');</script>
